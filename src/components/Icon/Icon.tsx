...
const itemLoaders = import.meta.glob<string>('../../assets/img/icons/items/item-*.png', {
    query: '?url',
    import: 'default',
});
...
export const Icon: React.FC<IconProps> = ({ name, item, size = 24, className, style, bounce = false, ...rest }) => {
